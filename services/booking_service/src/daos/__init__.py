...
from services.booking_service.src.db.db_dependencies import GetDBSessionRO, GetDBSession

from typing import Annotated, Any, Generic, Type, TypeVar, get_args, get_origin
...
from dtos.pagination_dtos import OffsetResults, PaginationParams
...
class DAOsRO:
    def __init__(self, dbsession: GetDBSessionRO):
        self.dbsession = dbsession


class DAOs:
    def __init__(self, dbsession: GetDBSession):
        self.dbsession = dbsession


GetDAOsRO = Annotated[DAOsRO, Depends(DAOsRO)]
GetDAOs = Annotated[DAOs, Depends(DAOs)]
